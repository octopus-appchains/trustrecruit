...
COPY --from=builder /appchain/target/release/appchain-trustrecruit /usr/local/bin
...
# check if executable works in this container
	/usr/local/bin/appchain-trustrecruit --version
...
ENTRYPOINT ["/usr/local/bin/appchain-trustrecruit"]
